...
#define shmem_wait_until_all(_ivars, _nelems, _status, _cmp, _cmp_value)       \
  _Generic(_ivars,                                                             \
...
#define shmem_wait_until_any(_ivars, _nelems, _status, _cmp, _cmp_value)       \
  _Generic(_ivars,                                                             \
...
#define shmem_wait_until_some(_ivars, _nelems, _indices, _status, _cmp,        \
                              _cmp_value)                                      \
  _Generic(_ivars,                                                             \
