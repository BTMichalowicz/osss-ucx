...
SHMEM_TYPE_WAIT_UNTIL_SOME_HELPER(short, short)
SHMEM_TYPE_WAIT_UNTIL_SOME_HELPER(unsigned short, ushort)

C11_SHMEM_STANDARD_AMO_TYPE_TABLE(SHMEM_TYPE_WAIT_UNTIL_SOME_HELPER)
