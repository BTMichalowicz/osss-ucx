/**
 * @file waitany_vector.c
 * @brief Implementation of OpenSHMEM wait operations for vectors
 *
 * This file provides wait operations for vectors that block until any element
...
#ifdef ENABLE_PSHMEM
#pragma weak shmem_short_wait_until_any_vector =                               \
    pshmem_short_wait_until_any_vector
...
#pragma weak shmem_long_wait_until_any_vector =                                \
    pshmem_long_wait_until_any_vector
#define shmem_long_wait_until_any_vector pshmem_long_wait_until_any_vector
#pragma weak shmem_longlong_wait_until_any_vector =                            \
    pshmem_longlong_wait_until_any_vector
#define shmem_longlong_wait_until_any_vector                                   \
  pshmem_longlong_wait_until_any_vector
#pragma weak shmem_ushort_wait_until_any_vector =                              \
    pshmem_ushort_wait_until_any_vector
#define shmem_ushort_wait_until_any_vector pshmem_ushort_wait_until_any_vector
#pragma weak shmem_uint_wait_until_any_vector =                                \
    pshmem_uint_wait_until_any_vector
#define shmem_uint_wait_until_any_vector pshmem_uint_wait_until_any_vector
#pragma weak shmem_ulong_wait_until_any_vector =                               \
    pshmem_ulong_wait_until_any_vector
#define shmem_ulong_wait_until_any_vector pshmem_ulong_wait_until_any_vector
#pragma weak shmem_ulonglong_wait_until_any_vector =                           \
    pshmem_ulonglong_wait_until_any_vector
#define shmem_ulonglong_wait_until_any_vector                                  \
  pshmem_ulonglong_wait_until_any_vector
#pragma weak shmem_int32_wait_until_any_vector =                               \
    pshmem_int32_wait_until_any_vector
#define shmem_int32_wait_until_any_vector pshmem_int32_wait_until_any_vector
#pragma weak shmem_int64_wait_until_any_vector =                               \
    pshmem_int64_wait_until_any_vector
#define shmem_int64_wait_until_any_vector pshmem_int64_wait_until_any_vector
#pragma weak shmem_uint32_wait_until_any_vector =                              \
    pshmem_uint32_wait_until_any_vector
#define shmem_uint32_wait_until_any_vector pshmem_uint32_wait_until_any_vector
#pragma weak shmem_uint64_wait_until_any_vector =                              \
    pshmem_uint64_wait_until_any_vector
#define shmem_uint64_wait_until_any_vector pshmem_uint64_wait_until_any_vector
#pragma weak shmem_size_wait_until_any_vector =                                \
    pshmem_size_wait_until_any_vector
#define shmem_size_wait_until_any_vector pshmem_size_wait_until_any_vector
#pragma weak shmem_ptrdiff_wait_until_any_vector =                             \
    pshmem_ptrdiff_wait_until_any_vector
#define shmem_ptrdiff_wait_until_any_vector pshmem_ptrdiff_wait_until_any_vector
#endif /* ENABLE_PSHMEM */

/**
 * @brief Waits until any element in a vector meets specified comparison
 * criteria
 *
 ...
 *
 * Blocks until any element in a vector meets specified comparison criteria.
...
#define SHMEM_TYPE_WAIT_UNTIL_ANY_VECTOR(_opname, _type, _size)                \
  size_t shmem_##_opname##_wait_until_any_vector(_type *ivars, size_t nelems,  \
    ...
    SHMEMT_MUTEX_PROTECT(switch (cmp) {                                        \
      case SHMEM_CMP_EQ:                                                       \
        return shmemc_ctx_wait_until_any_vector_eq##_size(                     \
            SHMEM_CTX_DEFAULT, (int##_size##_t *)ivars, nelems, status,        \
            cmp_values);                                                       \
        break;                                                                 \
      case SHMEM_CMP_NE:                                                       \
        return shmemc_ctx_wait_until_any_vector_ne##_size(                     \
            SHMEM_CTX_DEFAULT, (int##_size##_t *)ivars, nelems, status,        \
            cmp_values);                                                       \
        break;                                                                 \
      case SHMEM_CMP_GT:                                                       \
        return shmemc_ctx_wait_until_any_vector_gt##_size(                     \
            SHMEM_CTX_DEFAULT, (int##_size##_t *)ivars, nelems, status,        \
            cmp_values);                                                       \
        break;                                                                 \
      case SHMEM_CMP_LE:                                                       \
        return shmemc_ctx_wait_until_any_vector_le##_size(                     \
            SHMEM_CTX_DEFAULT, (int##_size##_t *)ivars, nelems, status,        \
            cmp_values);                                                       \
        break;                                                                 \
      case SHMEM_CMP_LT:                                                       \
        return shmemc_ctx_wait_until_any_vector_lt##_size(                     \
            SHMEM_CTX_DEFAULT, (int##_size##_t *)ivars, nelems, status,        \
            cmp_values);                                                       \
        break;                                                                 \
      case SHMEM_CMP_GE:                                                       \
        return shmemc_ctx_wait_until_any_vector_ge##_size(                     \
            SHMEM_CTX_DEFAULT, (int##_size##_t *)ivars, nelems, status,        \
            cmp_values);                                                       \
        break;                                                                 \
      default:                                                                 \
...
#define SHMEM_TYPE_WAIT_UNTIL_ANY_VECTOR_HELPER(CTYPE, SHMTYPE) \
  SHMEM_APPLY(SHMEM_TYPE_WAIT_UNTIL_ANY_VECTOR, SHMTYPE, CTYPE, SHMEM_TYPE_BITSOF_##SHMTYPE)

/* shorts are not in the table */
SHMEM_TYPE_WAIT_UNTIL_ANY_VECTOR_HELPER(short, short)
SHMEM_TYPE_WAIT_UNTIL_ANY_VECTOR_HELPER(unsigned short, ushort)

C11_SHMEM_STANDARD_AMO_TYPE_TABLE(SHMEM_TYPE_WAIT_UNTIL_ANY_VECTOR_HELPER)
