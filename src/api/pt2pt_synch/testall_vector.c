...
SHMEM_TYPE_TEST_ALL_VECTOR_HELPER(short, short)
SHMEM_TYPE_TEST_ALL_VECTOR_HELPER(unsigned short, ushort)

C11_SHMEM_STANDARD_AMO_TYPE_TABLE(SHMEM_TYPE_TEST_ALL_VECTOR_HELPER)
