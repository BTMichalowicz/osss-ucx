...
SHCOLL_ALLTOALL_DEFINITION(SHCOLL_ALLTOALLS_BARRIER_DEFINITION, shift_exchange,
                           SHIFT_PEER, 1, )
SHCOLL_ALLTOALL_DEFINITION(SHCOLL_ALLTOALLS_BARRIER_DEFINITION, shift_exchange,
                           SHIFT_PEER, 1, _nbi)

SHCOLL_ALLTOALL_DEFINITION(SHCOLL_ALLTOALLS_COUNTER_DEFINITION, shift_exchange,
                           SHIFT_PEER, 1, )
SHCOLL_ALLTOALL_DEFINITION(SHCOLL_ALLTOALLS_COUNTER_DEFINITION, shift_exchange,
                           SHIFT_PEER, 1, _nbi)
...
SHCOLL_ALLTOALL_DEFINITION(SHCOLL_ALLTOALLS_BARRIER_DEFINITION,
                           xor_pairwise_exchange, SHIFT_PEER, XOR_COND, )
SHCOLL_ALLTOALL_DEFINITION(SHCOLL_ALLTOALLS_BARRIER_DEFINITION,
                           xor_pairwise_exchange, SHIFT_PEER, XOR_COND, _nbi)

SHCOLL_ALLTOALL_DEFINITION(SHCOLL_ALLTOALLS_COUNTER_DEFINITION,
                           xor_pairwise_exchange, SHIFT_PEER, XOR_COND, )
SHCOLL_ALLTOALL_DEFINITION(SHCOLL_ALLTOALLS_COUNTER_DEFINITION,
                           xor_pairwise_exchange, SHIFT_PEER, XOR_COND, _nbi)
