...
#define DECLARE_REDUCE_BITWISE(_type, _typename)                               \
  ...
  SHCOLL_REDUCE_DECLARE(_typename, _type, and, sharp)                          \
  ...
  SHCOLL_REDUCE_DECLARE(_typename, _type, or, sharp)                           \
  ...
  SHCOLL_REDUCE_DECLARE(_typename, _type, xor, sharp)
...
#define DECLARE_REDUCE_MINMAX(_type, _typename)                                \
  ...
  SHCOLL_REDUCE_DECLARE(_typename, _type, min, sharp)                          \
  ...
  SHCOLL_REDUCE_DECLARE(_typename, _type, max, sharp)  
...
#define DECLARE_REDUCE_ARITH(_type, _typename)                                 \
  ...
  SHCOLL_REDUCE_DECLARE(_typename, _type, sum, sharp)                          \
  ...
  SHCOLL_REDUCE_DECLARE(_typename, _type, prod, sharp)
