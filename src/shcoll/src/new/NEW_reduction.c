...
#define SHCOLL_REDUCE_DEFINE(_name)                                            \
  /* AND operation */                                                          \
  _name(short_and, short, AND_OP) _name(int_and, int, AND_OP)                  \
      _name(long_and, long, AND_OP) _name(longlong_and, long long, AND_OP)     \
                                                                               \
      /* MAX operation */                                                      \
      _name(short_max, short, MAX_OP) _name(int_max, int, MAX_OP)              \
          _name(double_max, double, MAX_OP) _name(float_max, float, MAX_OP)    \
              _name(long_max, long, MAX_OP)                                    \
                  _name(longdouble_max, long double, MAX_OP)                   \
                      _name(longlong_max, long long, MAX_OP)                   \
                                                                               \
      /* MIN operation */                                                      \
      _name(short_min, short, MIN_OP) _name(int_min, int, MIN_OP)              \
          _name(double_min, double, MIN_OP) _name(float_min, float, MIN_OP)    \
      ...
      _name(complexd_sum, double _Complex, SUM_OP)                             \
          _name(complexf_sum, float _Complex, SUM_OP)                          \
              _name(short_sum, short, SUM_OP) _name(int_sum, int, SUM_OP)      \
      ...
      _name(complexd_prod, double _Complex, PROD_OP)                           \
          _name(complexf_prod, float _Complex, PROD_OP)                        \
              _name(short_prod, short, PROD_OP) _name(int_prod, int, PROD_OP)  \
                          ...
                          _name(long_prod, long, PROD_OP)                      \
                              _name(longdouble_prod, long double, PROD_OP)     \
                                  _name(longlong_prod, long long, PROD_OP)     \
                                                                               \
      /* OR operation */                                                       \
      _name(short_or, short, OR_OP) _name(int_or, int, OR_OP)                  \
          _name(long_or, long, OR_OP) _name(longlong_or, long long, OR_OP)     \
                                                                               \
      /* XOR operation */                                                      \
      _name(short_xor, short, XOR_OP) _name(int_xor, int, XOR_OP)              \
          _name(long_xor, long, XOR_OP) _name(longlong_xor, long long, XOR_OP)
